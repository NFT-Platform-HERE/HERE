...
export default function Footer() {
  return (
    <div className="flex h-300 w-full min-w-[1200px] justify-center bg-[#f7f7f7] text-14 font-light">
      <div className="w-500">
        <img src="images/logo.svg" className="mx-auto mt-100 w-150" />
      </div>
      <div className="w-700 px-30 py-60">
